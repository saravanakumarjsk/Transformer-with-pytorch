...
class ScaledDotProductAttention(nn.Module):
    ...
    def forward(self, Q, K, V, attn_mask):
        ...
        attn = nn.Softmax(dim=-1)(scores)  # sums up all the value from attn to 1, where the softmax ranges from 0 to 1.
...
class MultiHeadAttention(nn.Module):
    def __init__(self):
        ...
        # where W_Q = Weights of Q, becoz we multiply the weights with Q,k,v
